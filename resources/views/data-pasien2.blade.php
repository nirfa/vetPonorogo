...
@section('content')
   ...
   <div id="main">
      ...
      <div class="page-heading">
            ...
            <div class="float-end">
             <a href="/data-pasien">
                   <button class=" btn btn-secondary " style="margin-right:10px;">ALL</button>
               </a>
               <a href="/penyimpanan/c1">
                   <button class=" btn btn-secondary " style="margin-right:10px;">C1</button>
               </a>
               <a href="/penyimpanan/c2">
                   <button class=" btn btn-secondary active" style="margin-right:10px;" >C2</button>
               </a>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns">
                     ...
                     <?php
							$count = DB::table('hewan')->where('id_simpan','2')->count();
						   ?> 
                     Jumlah Pasien {{$count}}
                     @if ($data->hasPages())
