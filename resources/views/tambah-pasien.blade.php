                  ...
                  <div class="col-12">
                     <div class="card">
                        <div class="card-content">
                              <div class="card-body">
                                 <form class="form" method="POST" action="/submit/pasien" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                          <div class="col-md-6 col-12">
                                             <div class="form-group">
                                                ...
                                                <select class="livesearch form-control" width="500px" style="width:full;" id="livesearch" name="id_pemilik"></select>
                                             </div>
                                          </div>
                                          <div class="col-md-6 col-12">
                                             <div class="form-group">
                                                <label for="last-name-column">Nama Pasien</label>
                                                <input type="text" id="last-name-column" class="form-control"  name="nama">
                                             </div>
                                          </div>
                                          <div class="col-md-6 col-12">
                                          <div class="form-group">
