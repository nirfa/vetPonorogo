                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="terapi" disabled>{{$p->terapi}}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <select class="livesearch form-control" width="500px" style="width:full;"  id="id_stok" name="livesearch"></select>
                                            ...
                                            <div class="col-md-2" style="margin-top:26px;">
                                                <button id="addMore" class="btn btn-success btn-sm pull-right">Tambah Obat</button>
                                            </div>
                                        </div>
                                        <div class="mt-3"></div>
                                        <form action="{{ route('task') }}" method="post">
                                            ...
                                            <div class="col-12 d-flex justify-content-start">
                                                <button type="submit" class="btn btn-primary me-1 mb-1 mt-3">Simpan Obat</button>
                                            </div> 
