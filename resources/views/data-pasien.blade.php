...
@section('content')
    ...
    <div id="main">
        ...
        @if ($message = Session::get('success'))
            <div class="alert alert-light-success color-success"><i class="bi bi-check-circle"></i> {{ $message }}
            </div>
        @endif
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns">
                            <div class="dataTable-top">
                                ...
                                <form action="/pegawai/cari" method="GET">
                                    <div class="dataTable-search ">
                                        <input class="dataTable-input" type="text" id="myInput" onkeyup="myFunction()"
                                            placeholder="Cari nama pasien" title="Type in a name">
                                    </div>
                            </div>
                            ...
                            <?php
                            // config
                            $link_limit = $data->count(); // maximum number of links (a little bit inaccurate, but will be ok for now)
                            ?>
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-end">
                                        ...
                                        @for ($i = 1; $i <= $data->lastPage(); $i++)
                                            ...
                                            @if ($from < $i && $i < $to)
                                                <li
                                                    class="page-item {{ $data->currentPage() == $i ? ' disabled' : '' }}">
                                                    <a href="{{ $data->url($i) }}"
                                                        class="page-link">{{ $i }}</a>
                                                </li>
                                            @endif
